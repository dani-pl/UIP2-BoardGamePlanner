...
import { green50, purple50, globalStyles, backgroundColor } from '../../styles';
...
export const Dice8Shape = () => {
    return (
        <Svg width="120" height="120" viewBox="0 0 136 136" fill="none" xmlns="http://www.w3.org/2000/svg">
            <Path d="M1.45535 71.9954C-0.462785 70.057 -0.473999 66.9392 1.43014 64.9871L63.255 1.60552C65.1931 -0.381466 68.3789 -0.409417 70.3516 1.54326L134.384 64.9244C136.371 66.891 136.359 70.1045 134.358 72.0567L70.3255 134.533C68.3589 136.452 65.2124 136.424 63.2797 134.471L1.45535 71.9954Z" fill={purple50}/>
        </Svg>
    )
}
...
export const Dice10Shape = () => {
    return (
        <Svg width="120" height="120" viewBox="0 0 140 138"  fill="none">
            <Path d="M0 56.1073C0 54.5833 0.694999 53.1426 1.88772 52.194L65.7137 1.43228C67.5107 0.00309764 70.0501 -0.0185177 71.8712 1.37987L138.045 52.1943C139.278 53.1406 140 54.6061 140 56.16V86.7797C140 88.3776 139.236 89.8792 137.945 90.8204L74.711 136.909C72.9929 138.161 70.6708 138.19 68.9222 136.981L2.15625 90.8136C0.805919 89.8799 0 88.3428 0 86.701V56.1073Z" fill={purple50}/>
        </Svg>
    )
}
...
export const Dice20Shape = () => {
    return (
        <Svg width="120" height="120" viewBox="0 0 140 139" fill="none">
            <Path d="M0 41.4311C0 39.6211 0.97821 37.9524 2.55758 37.0682L66.3718 1.34365C67.8663 0.507006 69.685 0.493531 71.1917 1.30794L137.378 37.0825C138.993 37.9558 140 39.6445 140 41.4811V98.4818C140 100.338 138.972 102.041 137.329 102.906L71.1427 137.752C69.6618 138.532 67.889 138.519 66.4197 137.717L2.60633 102.921C0.999695 102.045 0 100.361 0 98.5314V41.4311Z" fill={purple50} />
        </Svg>
    )
}
